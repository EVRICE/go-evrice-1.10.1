...
import (
	...
	"github.com/EVRICE/go-evrice-1.10.1/crypto/signify"
	"github.com/EVRICE/go-evrice-1.10.1/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/EVRICE/go-evrice-1.10.1/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/EVRICE/go-evrice-1.10.1/mobile")
