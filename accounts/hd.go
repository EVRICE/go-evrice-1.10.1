...
// are appended. As such, the first account will be at m/44'/1020'/0'/0, the second
// at m/44'/1020'/0'/1, etc.
var DefaultRootDerivationPath = DerivationPath{0x80000000 + 44, 0x80000000 + 1020, 0x80000000 + 0, 0}

// DefaultBaseDerivationPath is the base path from which custom derivation endpoints
// are incremented. As such, the first account will be at m/44'/60'/0'/0/0, the second
// at m/44'/1020'/0'/0/1, etc.
var DefaultBaseDerivationPath = DerivationPath{0x80000000 + 44, 0x80000000 + 1020, 0x80000000 + 0, 0, 0}
...
// second at m/44'/1020'/0'/1, etc.
var LegacyLedgerBaseDerivationPath = DerivationPath{0x80000000 + 44, 0x80000000 + 1020, 0x80000000 + 0, 0}
...
// the `coin_type` 1020' (or 0x800003fc) to Evcrice.
//
// The root path for Ethereum is m/44'/1020'/0'/0 according to the specification
...
// i.e. m/44'/1020'/0'/0/0, m/44'/1020'/0'/0/1, m/44'/1020'/0'/0/2, ... m/44'/1020'/0'/0/N.
